...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <br>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Data Transaksi Penggajian</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tabel Transaksi Penggajian</h6>
                        </div>
                        <div class="card-body">
    ...
    $no = 1;
    $data = mysqli_query($koneksi, "SELECT * FROM transaksi inner join user on transaksi.iduser = user.iduser order by idtransaksi");
    ...
    ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                            <center><a href="edit_datatransaksi.php?idtransaksi=<?php echo $d['idtransaksi']; ?>">Edit</a></center>
                                            </td>
                                            <td>
                                            <center><a href="hapus_datatransaksi.php?idtransaksi=<?php echo $d['idtransaksi']; ?>">Hapus</a></a></center>
                                            </td>
                                        </tr>
    <?php } ?>
                                    </tbody>
